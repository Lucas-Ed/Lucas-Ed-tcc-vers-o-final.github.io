...
<br></br>
* A pesquisa também contribui para a linha histórica da tecnologia do token e visou reintroduzir na literatura brasileira descrevendo esse ecosssistema, em torno da tecnologia.
<br></br>
...
<p align="center">                        <!--largura--> <!--Altura-->
    <img src="img/smart.png" alt="Image" width="600" height="470" />
</p>
---
```{r echo=FALSE, fig.align='right', out.width="10%"}
knitr::include_graphics("img/fho.png")
...
* Valores mobiliários nunca foram criados antes fora do mercado financeiro.
